...
n_images = 1    # number of images to be visualized
id_batch = 2    # select the batch
layer = None    # None if all layer outputs has to be visualized, else specify a layer ID
